"""20-frantic-choir - mot file duy nhat, chi can numpy + scipy.
   python3 20-frantic-choir.py             -> ca hai ban wav
   python3 20-frantic-choir.py --vocals    -> chi ban co giong
   python3 20-frantic-choir.py --no-vocals -> chi ban instrumental
"""
# ================================================================= ENGINE (inlined)
import struct
import sys
